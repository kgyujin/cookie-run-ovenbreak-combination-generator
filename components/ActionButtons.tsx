  ...
  return (
    <div className="flex gap-2">
      <button
        ...
        className="flex-1 glass rounded-lg px-4 py-2 text-white text-sm font-bold hover:bg-white/30 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
